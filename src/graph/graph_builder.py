...
def build_graph():
    ...
    graph.add_node('planner_node',planner_node, cache_policy=CachePolicy(ttl=30))
    ...
    return graph.compile(checkpointer=checkpointer,store=store,cache=InMemoryCache())